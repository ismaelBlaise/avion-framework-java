...
public class ReservationDetail2 {
    ...
    private String dateDepot;   // date_depot
    private String categorieAge;
    private String classe;

    public ReservationDetail2() {
    }
    public ReservationDetail2(int idReservationDetail, int idReservation, int idCategorieAge, int idClasse,
            BigDecimal prix, byte[] passeport, String nomFichier, String dateDepot, String categorieAge,
            String classe) {
