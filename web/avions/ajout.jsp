<div class="max-w-4xl mx-auto py-8">
    ...
    <form action="avions-ajouter" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" id="modele" name="avion.modele" required placeholder="Entrer le modele de l'avion"
        ...
        <div>
            ...
            <input type="number" id="capacite" name="avion.capacite" required placeholder="Entrer la capacite de l'avion"
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
