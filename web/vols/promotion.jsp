...
<div class="max-w-4xl mx-auto py-8">
    ...
    <form action="vols-promotion-ajouter" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="number" id="pourcentage" name="promotion.pourcentage" required min="0" max="100" step="0.01"
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>

        <div>
            <label for="nbSiege" class="block text-gray-700 font-medium mb-2">Nombre de sièges disponibles</label>
            <input type="number" id="nbSiege" name="promotion.nbSiege" required min="0" step="1"
                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
