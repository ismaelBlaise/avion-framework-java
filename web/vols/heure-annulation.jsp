...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg p-6 sm:p-8">
        ...
        <div class="flex items-center mb-6">
            <i data-lucide="calendar-x" class="w-8 h-8 text-blue-500 mr-3"></i>
            <h2 class="text-2xl font-semibold text-gray-800">Definir la limite d'annulation</h2>
        </div>
        ...
        <form action="vols-heure-annulation" method="POST" class="space-y-6">
            ...
            <!-- Cancellation limit field -->
            <div class="space-y-2">
                <label for="heureAnnulation" class="block text-sm font-medium text-gray-700">Date limite d'annulation</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <i data-lucide="clock" class="w-5 h-5 text-gray-400"></i>
                    </div>
                    <input type="datetime-local" id="heureAnnulation" name="heureAnnulation" 
                ...
                <p class="mt-1 text-sm text-gray-500">Definissez la date et heure limite pour annuler ce vol</p>
            </div>
